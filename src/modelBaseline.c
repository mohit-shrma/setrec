...
float ModelBase_validationClassLoss(void *self, Data *data, float **sim) {
...
float ModelBase_testClassLoss(void *self, Data *data, float **sim) {
...
Model ModelBaseProto = {
  ...
  .validationClassLoss     = ModelBase_validationClassLoss,
  .testErr           = ModelBase_testErr,
  .testClassLoss          = ModelBase_testClassLoss
};
